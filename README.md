...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue?style=flat&logo=linkedin)](https://linkedin.com/in/nandhayogesh)
[![GitHub](https://img.shields.io/badge/GitHub-Follow-black?style=flat&logo=github)](https://github.com/nandhayogesh)
...
### Tools & Platforms
`Git/GitHub` • `Vercel` • `Postman` • `Excel` • `PowerPoint` • `GitHub Pages` • `Chrome DevTools` • `Jupyter Notebook` • `Visual Studio Code`
...
- Applied advanced concepts in information retrieval, natural language processing (NLP), and large language models for efficient question-answering and data-driven decision support in admissions
...
- Implemented end-to-end encryption for sensitive financial data transmission and storage

**Tech Stack:** `React 18` • `JavaScript ES6+` • `Tailwind CSS` • `PWA` • `Encryption`
...
- Designed intuitive dashboard with drag-and-drop file upload, progress tracking, and instant feedback mechanisms

**Tech Stack:** `React 18` • `Vite` • `TextRazor NLP API` • `Semantic Matching` • `Entity Extraction`
...
- Successfully deployed and optimized the solution on Vercel, leveraging CI/CD practices to maintain production reliability, high performance, and rapid update cycles for ongoing improvements and scalability

**Tech Stack:** `React` • `TypeScript` • `Vite` • `Tailwind CSS` • `AI Models` • `Vercel` • `CI/CD`
...
- **Responsive Design Excellence:** Practiced responsive design and accessibility techniques to ensure cross-browser compatibility and optimal user experiences
